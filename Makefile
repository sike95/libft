...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/05/29 22:14:08 by mmpofu            #+#    #+#              #
#    Updated: 2017/09/07 07:53:47 by mmpofu           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c\
	   ...
	   ft_tolower.c ft_memdel.c ft_strnew.c\
	   ft_memalloc.c ft_strdel.c ft_strclr.c\
	   ...
	   ft_putnbr_fd.c ft_strpbrk.c ft_isspace.c ft_swapbits.c\
	   ft_isprime.c ft_ispowerof2.c
